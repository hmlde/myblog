package com.hanmlet.myblog.common.util;
...
public class DateUtil {
	...
	public static final String DATE_FMT_mdhm = "MM.dd HH:mm";
	/**
	 * date format yyyy年MM月dd日
	 */
	...
	public static String getCurrentLocalDateTimeString() {
		return DateUtil.formatLocalDateTimeToString(DateUtil.getCurrentLocalDateTime(), DateUtil.TIME_PATTERN);
	}

	public static String getCurrentLocalDateTimeString(String pattern) {
		return DateUtil.formatLocalDateTimeToString(DateUtil.getCurrentLocalDateTime(), pattern);
	}
